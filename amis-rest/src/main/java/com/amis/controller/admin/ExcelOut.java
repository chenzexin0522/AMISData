...
//            cell.setCellStyle(style);
    ...
    @RequestMapping(value = "/downloadAimsOld")
    public String downloadAims(HttpServletRequest request,
                               HttpServletResponse response)throws UnsupportedEncodingException {
        // 获取指定目录下的第一个文件     D://AMISJAVA//picture_apk//apk//OldBadminton.apk
        File scFileDir = new File(" D://AMISJAVA//picture_apk//apk//OldBadminton.apk");
